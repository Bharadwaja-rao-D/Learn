...
impl Graph {
    ...
    pub fn new_unweighted() -> Graph {
        Graph {
            ...
            adjacency_list: vec![
                Graph::add_unweights(vec![1, 4]),
                Graph::add_unweights(vec![0, 2, 5]),
                Graph::add_unweights(vec![1, 4]),
                Graph::add_unweights(vec![4]),
                Graph::add_unweights(vec![0, 2, 3]),
                Graph::add_unweights(vec![1, 6]),
                Graph::add_unweights(vec![5]),
            ],
        }
    }
